  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 p-2 bg-gray-800 border border-gray-700 text-white rounded-sm"
      />
      <select
        name="ott"
        value={movieData?.ott}
        onChange={handleChange}
        className="bg-slate-900 border border-gray-300 cursor-pointer rounded-md"
      >
      ...
      <button
        type="submit"
        className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white cursor-pointer rounded"
      >
        Add
      </button>
    </form>
